      ...
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <div className="footer-socials">
            <a href="https://www.linkedin.com/in/mustafa-raheel-7b45b8286/" target="_blank" className="social-icon">
            ...
            <a href="https://github.com/MustafaRaheel26" target="_blank" className="social-icon">
              <div className='foot-icon'>
            ...
            <a href="mailto:mustafaraheel26@gmail.com" className="social-icon">
              <div className='foot-icon'>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
